...
<IntroParagraph>
  <UL>
    ...
    <LI>A component kit built on both.</LI>
  </UL>
</IntroParagraph>
...
In general, UI kits are hard because they have recursive complication; where every implementation detail has an outsize influence the one above it.
